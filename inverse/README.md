...
where $N_d$ is the total number of degrees of freedom. $\boldsymbol{u}[i]$ is the $i\text{th}$ _i_ th component of the dispalcement vector $\boldsymbol{u}$, which is obtained by solving the following discretized governing PDE:
