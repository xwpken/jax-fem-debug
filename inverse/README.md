...
where $N_d$ is the total number of degrees of freedom. $\boldsymbol{u}[i]$ is the $textit{i}$th component of the dispalcement vector $\boldsymbol{u}$, which is obtained by solving the following discretized governing PDE:
